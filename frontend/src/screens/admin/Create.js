...
const Create = () => {
 ...
 const submitHandler = (e) => {
    ...
    dispatch(createData({ adminForm , id:auth?.user?.id , navigate }));
 }
    ...
    <div style={{
        ...
        <section className='w-[60%] my-7 rounded-lg py-5 px-7 mx-auto' style={{
            ...
            <form onSubmit={submitHandler} className='w-full mt-10 flex flex-col gap-y-4'>
                ...
                <button type='submit' className="bg-orange-500 text-white border-2 border-orange-500 text-md font-semibold rounded-full py-2 px-6">Publish</button>
